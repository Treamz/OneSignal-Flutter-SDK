...
class OneSignalView extends StatefulWidget {
...
class _WebViewState extends State<OneSignalView> {
  ...
  Widget build(BuildContext context) {
    return OneSignalView.platform.build(
      context: context,
  ...
  @override
  void didUpdateWidget(OneSignalView oldWidget) {
...
CreationParams _creationParamsFromWidget(OneSignalView widget) {
...
WebSettings _webSettingsFromWidget(OneSignalView widget) {
  return WebSettings(
...
class WebViewController {
  ...
  Future<void> _updateWidget(OneSignalView widget) async {
    _widget = widget;
